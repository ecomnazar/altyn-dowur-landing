        ...
        <Section className="!pb-0 relative">
            <Container>
                ...
                <div className="grid grid-cols-1 -space-y-8 md:space-y-0 md:grid-cols-6 mt-12 md:mt-48 relative z-[99]">
                    <div className="flex flex-col justify-end first md:-translate-y-[20px] lg:translate-y-0 items-center w-fit md:w-auto mr-auto md:mr-0">
                    ...
                    <div className="flex flex-col justify-end md:-translate-y-[65px] lg:-translate-y-[60px] items-center second w-fit md:w-auto ml-auto md:ml-0">
                    ...
                    <div className="flex flex-col justify-end md:-translate-y-[88px]  items-center w-fit md:w-auto mr-auto md:mr-0">
                    ...
                    <div className="flex flex-col justify-end md:-translate-y-[88px] items-center w-fit md:w-auto ml-auto md:ml-0">
                    ...
                    <div className="flex flex-col justify-end md:-translate-y-[65px] -lg:translate-y-[60px] items-center second w-fit md:w-auto mr-auto md:mr-0">
                    ...
                    <div className="hidden md:flex flex-col justify-end first md:-translate-y-[20px] lg:translate-y-0 items-center w-fit md:w-auto ml-auto md:ml-0">
                ...
                <Button className="block mx-auto md:-translate-y-16 mt-8 md:mt-0">ЗАКАЗАТЬ ЗВОНОК</Button>
            </Container>
        </Section>
    )
}
