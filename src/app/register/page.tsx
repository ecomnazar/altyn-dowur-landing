        ...
        <div className='w-screen h-screen flex items-center relative justify-center'>
            ...
            <form className='max-w-[80%] md:max-w-[600px] w-full'>
                ...
                <div className='space-y-4'>
                    ...
                    <PasswordInput />
                    <Button className='hover:!bg-white hover:!text-primary border border-primary transition-all w-full h-[52px] flex items-center !text-[16px] font-semibold justify-center'>Зарегистрироваться</Button>
                </div>
            </form>
